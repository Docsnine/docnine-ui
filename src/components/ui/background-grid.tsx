        ...
        <div>
            <div
                ...
                style={{
                    ...
                    maskImage: 'linear-gradient(to bottom, transparent 0%, black 8%, black 65%, transparent 100%)',
                    WebkitMaskImage: 'linear-gradient(to bottom, transparent 0%, black 8%, black 65%, transparent 100%)',
                }}
            />
        </div>
    )
